...
let frutas = ['Abacaxi', 'Banana', 'Morango', 'Uva', 'Pera'];
console.log(frutas);
console.log(frutas[4]);
// => Exemplo 02 - Array Object (Objeto Array)
let frutas1 = ['Abacaxi', 'Banana', 'Morango', 'Uva', 'Pera'];
...
let linguagensArray = new Array('JavaScript', 'Python', 'Java', 'TypeScript', 'C#');
